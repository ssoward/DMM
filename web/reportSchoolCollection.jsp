...
<%
            ...
            ArrayList<CollectionRpt> uu = cu.getSchoolCollectionReport();
%>
<h1>School Aging Report</h1>
		<table class="sortable, simple" id="viewAccounts" width="780" align="center" cellpadding="0" cellspacing="0">
			<tr>
        <th>&nbsp;#   &nbsp;</th>
        <th>&nbsp;Name   &nbsp;</th>
        <th>&nbsp;Account   &nbsp;</th>
