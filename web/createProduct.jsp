...
<SCRIPT LANGUAGE="JavaScript">
  ...
  function validateValues(){
    ...
    var inx = document.getElementById("department").value;
    if(inx != null && inx!='0'){
      butt.value='Loading...'; butt.disabled = true;
      butt.form.submit();
    }else{
      document.getElementById("departmentReq").className = "invalidElement";
      applicationNotificaiton('Missing Required Fields', "ERROR");
    }
  }
</script>
...
<form name="productForm" action="createProduct.jsp">
...
<td>
    <table border=0 cellspacing="3" cellpadding="3">
      ...
      if(qty>0){ %><option value="<%=qty%>"><%=qty%></option><% }
        ...
        <tr><td><div id="departmentReq">Department:</div> </td><td colspan=2>
            <select id="department" name="department" onchange="refreshDescriptions();">
...
<center><br>
    <input type="button" id="saveButton" value="Save" onclick="validateValues();" class="btn" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <%if(popup){%>
