...
public abstract class Barcode {
     ...
     * 
     * @param codeType
     *            String Codebar type(Barcode.TYPE_CODE128 or
     *            Barcode.TYPE_CODE93 or Barcode.INTERLEAVED2OF5)
     * 
     * @param codeValue
     *            String The code to represent
     * 
     */
...
//    }
     ...
     * 
     * @param barHeight
     *            float The bar height in pixels
     * 
     * @param fontName
     *            String The name of the font to use
     * 
     * @param fontSize
     *            int The size of the font to use
     * 
     * @param transparent
     *            boolean Use transparent background
     * 
     * @param alignment
     *            int Text alignment :use Barcode.ALIGN_CENTER,
     *            Barcode.ALIGN_LEFT, Barcode.ALIGN_RIGHT
     * 
     * @param fontStyle
     *            int The style of the font to use: BOLD, ITALIC OR PLAIN
     * 
     * @param barColor
     *            Color Color to use in the bars
     * 
     * @param textColor
     *            Color Color to use in the text
     * 
     * @param orientacion
     *            int rotation angle of the image in radians: 0,PI/2, PI or
     *            (3/2)*PI
     * 
     */
...
//    }
     ...
     * 
     * The size of the barcode width will be the minimun posible but optimal for
     * reading
     * 
...
//    /**
//     * 
//     * Creates a PNG image data that represents the barcode,and rotates the
//     * image.
//     * 
//     * @return byte[] A bytearray witht he data of the image
//     * 
...
//    throws Exception {
//
//        // Create the image to place the barcode and the resulting image after
//        // rotation
//
//        BufferedImage image = new BufferedImage( x, y, colorspace );
//
...
//    }
     ...
     * Creates a PNG image data that represents the barcode.
     * 
     * The size of the barcode will be the minimun posible but optimal for
     * reading
     * 
     * @return byte[] A bytearray witht he data of the image
     * 
...
//    }
    ...
    /**
     * Sets the property to show the start and stop character '*' in the text
     * for
     * 
     * the barcode 39.
     * 
     ...
     * 
     * @param angle
     *            Angle to rotate the image(values allowed: PI/2, PI, 3*PI/2 and
     *            0)
     * 
     */
    ...
    throws Exception {
        ...
        // Depending of the orientation of the rotating image the size of the
        // image will differ
     ...
     * 
     * Example: Having the logical dimension 200, and the logical coordinate
     * 20.5 we want
     * 
    ...
    /**
     * Sets the font to use null font prints no text. default value is
     * Helvetica,Plain, size 20
     * 
     * @param newFont
     *            java.awt.Font
     */
    ...
    /**
     * Gets the property to show the start and stop character '*' in the text
     * for the barcode 39.
     * 
     * @param startStopText
    ...
    /**
     * Creates a JPG image data that represents the barcode. The size of the
     * barcode width will be the minimun posible but optimal for reading
     * 
     * @return byte[] A bytearray witht he data of the image
     * @param y
     *            The x size of the image
    ...
    public byte[] createJPG( int y, Color barColor, Color textColor, double angle, Product prod ) throws Exception {
        int x = Math.round( getBarcodeWidth() );
        int colorspace = BufferedImage.TYPE_INT_RGB;
        // Create the JPG
        return createJPG( x, y, colorspace, barColor, textColor, angle, prod );
    }

    /**
     * Creates a PNG image data that represents the barcode. The size of the
     * barcode width will be the minimun posible but optimal for reading
     * 
     * @return byte[] A bytearray witht he data of the image
     * @param y
    ...
    public byte[] createJPG( int y, Color barColor, Color textColor, int colorspace, Product prod ) {
        int x = Math.round( getBarcodeWidth() );
        // Create the PNG
        return createJPG( x, y, colorspace, barColor, textColor, prod );
    }

    /**
     * Creates a PNG image data that represents the barcode. The size of the
     * barcode will be the minimun posible but optimal for reading
     * 
     * @return byte[] A bytearray witht he data of the image
     * @param y
     *            The x size of the image
    ...
    public byte[] createJPG( int y, Color barColor, Color textColor, int colorspace, double angle, Product prod ) throws Exception {
        int x = Math.round( getBarcodeWidth() );
        // Create the PNG
        return createJPG( x, y, colorspace, barColor, textColor, angle, prod );
    }
    ...
    public byte[] createJPG( int x, int y, int colorspace, Color barColor, Color textColor, Product prod ) {
        // Create a image
        BufferedImage image = new BufferedImage( x, y, colorspace );
        // Paint the background of the image
        Graphics2D g = (Graphics2D) image.createGraphics();
        ...
        g.fillRect( 0, 0, x, y );
        // Paint the barcode
        placeBarcode( image, barColor, textColor, prod );
        // Encode the image into a PNG
    ...
    public byte[] createJPG( int x, int y, int colorspace, Color barColor, Color textColor, double angle, Product prod ) throws Exception {
        // Create the image to place the barcode and the resulting image after
        // rotation
        x=200;
        BufferedImage image = new BufferedImage( x, y, colorspace );
