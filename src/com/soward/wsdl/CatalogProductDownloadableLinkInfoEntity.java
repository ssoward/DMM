...
public class CatalogProductDownloadableLinkInfoEntity  implements java.io.Serializable {
    private com.soward.wsdl.CatalogProductDownloadableLinkEntity[] links;

    private com.soward.wsdl.CatalogProductDownloadableLinkSampleEntity[] samples;

    public CatalogProductDownloadableLinkInfoEntity() {
    }

    public CatalogProductDownloadableLinkInfoEntity(
           com.soward.wsdl.CatalogProductDownloadableLinkEntity[] links,
           com.soward.wsdl.CatalogProductDownloadableLinkSampleEntity[] samples) {
           this.links = links;
     ...
     * @return links
     */
    public com.soward.wsdl.CatalogProductDownloadableLinkEntity[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(com.soward.wsdl.CatalogProductDownloadableLinkEntity[] links) {
        this.links = links;
    }
     ...
     * @return samples
     */
    public com.soward.wsdl.CatalogProductDownloadableLinkSampleEntity[] getSamples() {
        return samples;
    }
     ...
     * @param samples
     */
    public void setSamples(com.soward.wsdl.CatalogProductDownloadableLinkSampleEntity[] samples) {
        this.samples = samples;
    }
