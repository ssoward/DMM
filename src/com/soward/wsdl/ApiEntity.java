...
public class ApiEntity  implements java.io.Serializable {
    ...
    private com.soward.wsdl.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           com.soward.wsdl.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public com.soward.wsdl.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(com.soward.wsdl.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
