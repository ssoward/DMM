...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private com.soward.wsdl.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           com.soward.wsdl.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public com.soward.wsdl.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(com.soward.wsdl.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
