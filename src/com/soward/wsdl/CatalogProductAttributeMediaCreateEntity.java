...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private com.soward.wsdl.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           com.soward.wsdl.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public com.soward.wsdl.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(com.soward.wsdl.CatalogProductImageFileEntity file) {
        this.file = file;
    }
