...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private com.soward.wsdl.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           com.soward.wsdl.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public com.soward.wsdl.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(com.soward.wsdl.AssociativeEntity[] products) {
        this.products = products;
    }
