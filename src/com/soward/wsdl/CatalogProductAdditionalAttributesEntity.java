...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private com.soward.wsdl.AssociativeMultiEntity[] multi_data;

    private com.soward.wsdl.AssociativeEntity[] single_data;

    public CatalogProductAdditionalAttributesEntity() {
    }

    public CatalogProductAdditionalAttributesEntity(
           com.soward.wsdl.AssociativeMultiEntity[] multi_data,
           com.soward.wsdl.AssociativeEntity[] single_data) {
     ...
     * @return multi_data
     */
    public com.soward.wsdl.AssociativeMultiEntity[] getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(com.soward.wsdl.AssociativeMultiEntity[] multi_data) {
        this.multi_data = multi_data;
    }
     ...
     * @return single_data
     */
    public com.soward.wsdl.AssociativeEntity[] getSingle_data() {
        return single_data;
    }
     ...
     * @param single_data
     */
    public void setSingle_data(com.soward.wsdl.AssociativeEntity[] single_data) {
        this.single_data = single_data;
    }
