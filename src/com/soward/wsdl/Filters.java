...
public class Filters  implements java.io.Serializable {
    private com.soward.wsdl.AssociativeEntity[] filter;

    private com.soward.wsdl.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           com.soward.wsdl.AssociativeEntity[] filter,
           com.soward.wsdl.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public com.soward.wsdl.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.soward.wsdl.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public com.soward.wsdl.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(com.soward.wsdl.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
