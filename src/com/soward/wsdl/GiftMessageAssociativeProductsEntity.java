...
public class GiftMessageAssociativeProductsEntity  implements java.io.Serializable {
    private com.soward.wsdl.ShoppingCartProductEntity product;

    private com.soward.wsdl.GiftMessageEntity message;

    public GiftMessageAssociativeProductsEntity() {
    }

    public GiftMessageAssociativeProductsEntity(
           com.soward.wsdl.ShoppingCartProductEntity product,
           com.soward.wsdl.GiftMessageEntity message) {
     ...
     * @return product
     */
    public com.soward.wsdl.ShoppingCartProductEntity getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(com.soward.wsdl.ShoppingCartProductEntity product) {
        this.product = product;
    }
     ...
     * @return message
     */
    public com.soward.wsdl.GiftMessageEntity getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(com.soward.wsdl.GiftMessageEntity message) {
        this.message = message;
    }
